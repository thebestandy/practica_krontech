...
class AdevarulScraper:
    ...
    def build_tag_url(self, query: str) -> str:
    ...
    def search(self, target: str, limit: int = 5) -> dict:
        ...
        for page_url in [self.build_tag_url(target), self.build_search_url(target)]:
