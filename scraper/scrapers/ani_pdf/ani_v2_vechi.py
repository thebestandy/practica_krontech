...
class LegacyScraper:
    ...
    def _extract_metadata(self, text: str):
        ...
        t = text.lower()
        doc_type = "avere" if "avere" in t else "interese" if "interese" in t else "unknown"
    ...
    def _parse_results(self, html: str) -> List[PersonResult]:
        ...
        for row in data_rows:
            ...
            existing_person = next((p for p in results if p.name == name and p.institution == inst), None)
